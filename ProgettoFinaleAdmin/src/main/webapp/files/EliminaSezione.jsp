...
<body>
	...
	<header class="w3-container w3-blue w3-center"
		...
		<div class="container">
			...
			<h4 style="text-align: center;">Elimina una Sezione</h4>

			<form action="ConfirmEliminaSezione.jsp" style="text-align: center;">
			
			
			<%
			List<Sezione> sezione = Sezioni.ReadAllSezioni();

			if (sezione.size() == 0) {
				String redirectURL = "fail.jsp";
				response.sendRedirect(redirectURL);
			}
			for (Sezione sezioni : sezione) {
			%>
