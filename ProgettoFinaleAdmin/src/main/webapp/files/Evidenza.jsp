...
<!DOCTYPE html>
<html lang="en">
<title>Amministrazione - In Evidenza</title>
<meta charset="UTF-8">
...
<body>
	...
	<header class="w3-container w3-blue w3-center"
		...
		<h4 style="text-align: center;">Documenti In Evidenza</h4>
		<br>
		<%
			List<Documento> documento = Documenti.ReadAllByAdmin();
