...
<!DOCTYPE html>
<html lang="en">
<title>Amministrazione - Modifica Doc</title>
<meta charset="UTF-8">
...
Documento doc = new Documento(id,titolo,data);

Documenti.UpdateDocumenti(doc);;
%>

	
	<h1 style="text-align: center;">Documento Modificato!</h1>
