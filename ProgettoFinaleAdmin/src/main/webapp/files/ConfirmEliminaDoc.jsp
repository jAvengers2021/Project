	...
	<div class="w3-top">
		<div class="w3-bar w3-blue w3-card w3-left-align w3-large">
			...
			<a href="CreateDocumento.jsp"
				class="w3-bar-item w3-button w3-hide-small w3-padding-large w3-hover-white">Creazione Doc</a>
			...
			<a href=ModificaDocumento.jsp
				class="w3-bar-item w3-button w3-hide-small w3-padding-large w3-hover-white">Modifica Doc</a>
				<a href="ModificaSezioni.jsp"
				class="w3-bar-item w3-button w3-hide-small w3-padding-large w3-hover-white">Modifica Sezioni</a>
...
<body>
	...
	Documenti.DeleteDocumenti(id);
	%>
	<h1 style="text-align: center;">Documento Eliminato!</h1>
</body>
