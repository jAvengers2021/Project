...
<!DOCTYPE html>
<html lang="en">
<title>Amministrazione - Documento creato</title>
<meta charset="UTF-8">
...
<body>
	...
	int amministratore = Integer.parseInt(request.getParameter("amministratore"));

	Documenti.CreateDocumento(titolo, data, amministratore);
	%>
	<h1 style="text-align: center;">Documento Creato!</h1>
</body>
